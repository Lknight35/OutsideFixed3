...
import {
  ...
  Moon, Star, TreePine, ShoppingBag, Shirt, Dices, Sunset, Dribbble,
...
const CAT_ICONS = {
  ...
  clothing: Shirt, casinos: Dices, sunsets: Sunset, basketball: Dribbble,
...
.outside{
  ...
  font-family:var(--font); color:var(--text); background:#000; min-height:100vh;
...
.phone{position:relative; width:100%; max-width:430px; height:100vh; max-height:932px; background:var(--bg);
...
@media (min-width:480px){.phone{height:min(94vh,920px); border:1px solid var(--line); border-radius:34px; box-shadow:0 40px 120px rgba(0,0,0,.65);}}
